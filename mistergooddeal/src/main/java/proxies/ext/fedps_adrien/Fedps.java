...
public class Fedps extends Service {
    ...
    public final static QName SERVICE = new QName("http://fedps.adrien.transport.external/", "Fedps");
    public final static QName FedpsServicePort = new QName("http://fedps.adrien.transport.external/", "FedpsServicePort");
    static {
        URL url = null;
        try {
