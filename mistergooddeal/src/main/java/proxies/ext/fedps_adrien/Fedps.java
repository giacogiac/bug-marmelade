 ...
 * 2013-10-28T16:55:56.563+01:00
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "Fedps", 
                  wsdlLocation = "file:/D:/git/bug-marmelade/mistergooddeal/src/main/resources/fedps_andrien.wsdl",
...
public class Fedps extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/git/bug-marmelade/mistergooddeal/src/main/resources/fedps_andrien.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Fedps.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/git/bug-marmelade/mistergooddeal/src/main/resources/fedps_andrien.wsdl");
        }
        WSDL_LOCATION = url;
    }
