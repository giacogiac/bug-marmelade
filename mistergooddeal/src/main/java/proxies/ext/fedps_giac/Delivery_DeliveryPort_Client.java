 ...
 * 2013-10-28T16:54:02.864+01:00
 * Generated source version: 2.5.1
 * 
 */
public final class Delivery_DeliveryPort_Client {

    private static final QName SERVICE_NAME = new QName("http://fedps.giac.transport/", "DeliveryServiceService");

    private Delivery_DeliveryPort_Client() {
    }

    public static void main(String args[]) throws java.lang.Exception {
        URL wsdlURL = DeliveryServiceService.WSDL_LOCATION;
        ...
        DeliveryServiceService ss = new DeliveryServiceService(wsdlURL, SERVICE_NAME);
        Delivery port = ss.getDeliveryPort();  
